...
@section('content')
<div class="relative min-h-screen antialiased text-stone-900 dark:text-stone-200 selection:bg-rose-500/30">
  ...
  <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    {{-- HERO CARD --}}
    <section class="pt-8">
      <div class="rounded-2xl bg-white/90 backdrop-blur ring-1 ring-black/5 p-6 sm:p-8 shadow-xl
