...
<section class="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
  ...
  {{-- LEFT: History features (three stacked cards) --}}
  <div class="lg:col-span-2">
    ...
    <div class="space-y-6">
      @if($event)
        <article class="rounded-2xl bg-white dark:bg-stone-800/70 shadow p-6">
          ...
          <div class="mt-4 text-center">
            <a href="{{ route('history.show', ['tab' => 'events', 'decade' => $event['decade'], 'id' => $event['id']]) }}"
               class="inline-flex items-center font-semibold text-blue-600 dark:text-rose-400 hover:underline">
              Read more
            </a>
          </div>
        </article>
  ...
  {{-- RIGHT: Next rallies --}}
  <aside class="rounded-2xl bg-white dark:bg-stone-800/70 shadow p-5">
        ...
        <li class="py-3">
          ...
          @if(!empty($e->slug))
            <a href="{{ route('events.show', $e->slug) }}"
               class="text-xs font-medium text-blue-600 dark:text-rose-400 hover:underline mt-1 inline-block">
              Event details
            </a>
          @endif
        </li>
    ...
    <a href="{{ route('calendar.index') }}"
       class="mt-3 inline-flex items-center text-sm font-semibold text-blue-600 dark:text-rose-400 hover:underline">
      Open full calendar
    </a>
  </aside>
</section>
