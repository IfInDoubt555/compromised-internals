...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Recent Posts -->
        <div class="bg-white shadow-sm sm:rounded-lg p-6 max-h-64 overflow-y-auto max-w-148">
            ...
            <ul class="list-disc list-inside space-y-1">
                @foreach ($user->posts as $post)
                    <li class="flex justify-between items-center">
                        ...
                        <form action="{{ route('posts.destroy', $post) }}" method="POST" onsubmit="return confirm('Delete this post?')" class="ml-2">
                            @csrf
                            @method('DELETE')
