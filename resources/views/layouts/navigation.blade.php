<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            <!-- Left: Logo + Auth Dropdown or Guest Links -->
            ...
            <div class="hidden lg:flex items-center space-x-3">
                ...
                <x-nav-link href="{{ route('blog.index') }}" :active="request()->routeIs('blog.index')">{{ __('Blog') }}</x-nav-link>
                <x-nav-link href="{{ route('calendar') }}" :active="request()->routeIs('calendar')">{{ __('Calendar') }}</x-nav-link>
                <x-nav-link href="{{ route('charity.index') }}" :active="request()->routeIs('charity.index')">{{ __('Charity Work') }}</x-nav-link>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('charity.index') }}" :active="request()->routeIs('charity.index')">{{ __('Charity Work') }}</x-responsive-nav-link>
        </div>
    </div>
</nav>
