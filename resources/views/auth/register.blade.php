<x-guest-layout>
    <div class="min-h-screen flex lg:flex-row flex-col items-center justify-center bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 px-4 sm:px-6 lg:px-8 overflow-hidden">
