...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <h1 class="text-3xl font-bold mb-8">Shop</h1>
        <div class="mb-6 p-4 rounded-lg border border-yellow-400 bg-yellow-100 dark:bg-yellow-900 text-yellow-900 dark:text-yellow-100  shadow-md animate-fade-in">
