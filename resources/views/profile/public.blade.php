    ...
    <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div class="flex-1">
            <h1 class="text-3xl font-bold text-center md:text-left mb-4 flex flex-wrap items-center gap-2">
                ...
                <span class="text-sm font-semibold bg-blue-100 text-blue-800 px-3 py-1 rounded-full shadow">
            ...
            @endif
            @else
            <p class="text-sm text-gray-500 mt-4">This user hasn't filled out their profile yet.</p>
            @endif
        </div>
    </div>
</div>
